...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.required) {
      document.getElementById(plugin_id_name + '-next').disabled = true;
      $('input[type="radio"]').on('click', function(e) {
        document.getElementById(plugin_id_name + '-next').disabled = false;
      });
    }
    ...
    $trial_form.submit(function(event) {
      ...
      var question_data = $("div." + plugin_id_name + "-question").find("input:radio:checked").val();
      // var question_data = {};

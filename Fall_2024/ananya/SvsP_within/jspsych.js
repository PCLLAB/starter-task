...
var jsPsych = (function() {
  ...
  core.init = function(options) {
    ...
    // default functions probably go here
    var defaults = {
  ...
  // todo probably where we will add
  ...
  function updateProgressBar() {
    ...
    var percentageComplete = (progress.current_trial_global / progress.total_trials) * 100;

    $('#jspsych-progressbar-inner').css('width', percentageComplete + "%");
  }

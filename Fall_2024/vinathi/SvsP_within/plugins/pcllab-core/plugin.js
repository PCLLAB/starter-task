...
},{"process/browser.js":9,"timers":12}],13:[function(require,module,exports){
(function() {
  function getBytes() {
    try {
      // Modern Browser
...
const ResponseKeyboardView = require("./views/response/keyboardView")
...
class Core {
	constructor(display_element, trial) {
		...
		this.isi_hide_button_container = setParameter(trial.isi_hide_button_container, true, "boolean");
		this.isi_hide_trial_container = setParameter(trial.isi_hide_trial_container, true, "boolean");
		this.isi_hide_progress_container = setParameter(trial.isi_hide_progress_container, true, "boolean");
		...
		this.total_maximum_time = setParameter(trial.total_maximum_time, 0, "number")
	...
	_start() {
		...
		if (this.total_maximum_time) {
			globalThis.setTimeout(()=>{
				this._data.endRecall()
				this.end()
			}, this.total_maximum_time)
		}
	}
	...
	showRecall(stimulus) {
		...
		let responseCount = setParameter(stimulus.response_count, this.response_count, 'number');
		...
		if (stimulus.show_stacked_cue_response) {
			...
			for (let i = 0; i < cueResponseLayers; i++) {
				let layerResponseCount = stimulus.response_count_list ? stimulus.response_count_list[i]:responseCount;
				let layerCueList = stimulusCueList.slice(0, layerResponseCount)
				let layerStimulus = {...stimulus, cue_list:layerCueList, response_count: layerCueList.length};
				...
				responseViewType = setParameter(stimulus.response_type, RESPONSE_TYPE.input, "string")
				responseView = null
				switch (responseViewType) {
					case RESPONSE_TYPE.slider: {
						responseView = new ResponseSliderView($responsePanel, this, this._data, layerStimulus)
						break
					}
		
					case RESPONSE_TYPE.radio: {
						responseView = new ResponseRadioView($responsePanel, this, this._data, layerStimulus)
						break
					}
		
					case RESPONSE_TYPE.study_items: {
						responseView = new ResponseInputView($responsePanel, this, this._data, layerStimulus)
						break
					}
		
					case RESPONSE_TYPE.button: {
						responseView = new ResponseButtonView($responsePanel, this, this._data, layerStimulus)
						break
					}
		
					case RESPONSE_TYPE.free_recall: {
						responseView = new ResponseFreeRecallView($responsePanel, this, this._data, layerStimulus)
						break
					}
		
					case RESPONSE_TYPE.horizontal_input: {
						responseView = new ResponseHorizontalInputView($responsePanel, this, this._data, layerStimulus)
						break;
					}
			...
			for(let rv = responseViews.length -1; rv >=0; rv--) {
				...
				if (rv == responseViews.length-1) {
					...
					responseView.responseContainers = responseViews[rv].responseContainers.concat(responseView.responseContainers)
				...
				switch (responseViewType) {
					...
					case RESPONSE_TYPE.keyboard: {
						responseView = new ResponseKeyboardView($responsePanel, this, this._data, stimulus, () => this._endRecall(stimulus, []))
						break
					}
					...
					case RESPONSE_TYPE.horizontal_input: {
						responseView = new ResponseHorizontalInputView($responsePanel, this, this._data, stimulus)
						break;
					}
...
},{"./buttons":14,"./constants":15,"./data":17,"./handlers/forcedResponseHandler":19,"./pluginAPI":24,"./progressBar":25,"./util":27,"./views/recall/horizontalView":29,"./views/recall/standardView":30,"./views/recall/wordBankView":31,"./views/response/buttonView":32,"./views/response/freeRecallView":40,"./views/response/horizontalInputView":41,"./views/response/inputView":42,"./views/response/keyboardView":43,"./views/response/radioView":44,"./views/response/sliderView":45,"uuid4":13}],17:[function(require,module,exports){
...
class Data {
	...
	endRecall() {
		...
		if (this.scorer) {
			...
			this.scorer.score(currentDataBlock.response, targets).then(score => {
...
},{"./scoring":26,"./util":27,"uuid4":13}],18:[function(require,module,exports){
...
},{"../views/response/containers/button":34}],19:[function(require,module,exports){
/**
...
},{"./core":16,"./util":27}],24:[function(require,module,exports){
class PluginAPI {
	constructor(coreInstance) {
...
},{"./constants":15,"string-similarity":10}],27:[function(require,module,exports){
...
},{"./standardView":30}],30:[function(require,module,exports){
const RESPONSE_TYPE = require('../../constants').RESPONSE_TYPE
...
},{"../../constants":15,"../../util":27}],31:[function(require,module,exports){
...
},{"../../constants":15,"../../util":27,"../response/containers/honeypot":36,"dragula":8}],32:[function(require,module,exports){
...
},{"../../handlers/buttonHandler":18,"../../util":27,"./containers/button":34,"./inputView":42}],33:[function(require,module,exports){
// Util
const UUID4 = require('uuid4')
...
},{"uuid4":13}],34:[function(require,module,exports){
...
},{"../../../constants":15,"../../../util":27,"./base":33}],35:[function(require,module,exports){
const ResponseContainer = require("./base")
...
},{"../../../constants":15,"../../../util":27,"./base":33}],36:[function(require,module,exports){
...
},{"../../../constants":15,"../../../util":27,"./base":33}],38:[function(require,module,exports){
const ResponseContainer = require("./base")
...
},{"../../../util":27,"./base":33,"uuid4":13}],39:[function(require,module,exports){
require('../../misc/slider')
const ResponseContainer = require('./base')
...
},{"../../../util":27,"../../misc/slider":28,"./base":33}],40:[function(require,module,exports){
const InputView = require('./inputView')
...
},{"../../handlers/freeRecallHandler":20,"../../util":27,"./containers/freeRecall":35,"./inputView":42}],41:[function(require,module,exports){
const InputView = require("./inputView")
...
},{"../../util":27,"./inputView":42}],42:[function(require,module,exports){
...
},{"../../handlers/inputHandler":21,"../../util":27,"./containers/honeypot":36,"./containers/input":37}],43:[function(require,module,exports){
// Handler
const InputHandler = require('../../handlers/inputHandler')
const clearAllTimers = require("../../util").clearAllTimers
class KeyboardView {
...
},{"../../handlers/inputHandler":21,"../../util":27}],44:[function(require,module,exports){
const InputView = require('./inputView')
...
},{"../../handlers/radioHandler":22,"../../util":27,"./containers/radio":38,"./inputView":42}],45:[function(require,module,exports){
const InputView = require('./inputView')
...
},{"../../util":27,"./containers/slider":39,"./inputView":42}]},{},[23]);

 ...
 jsPsych.plugins['cued-recall'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    $('#jspsych-cued-recall-header').html(trial.preamble); 
      ...
      // add text box
      $("#jspsych-cued-recall").append('<center><textarea id="jspsych-cued-recall-response" cols="20" rows="1" onkeypress="return restrictCharacters(this, event, alphaOnly)"></textarea></center>');
    ...
    $("#jspsych-cued-recall-response").focus();
    $("#jspsych-cued-recall-response").keypress(function(event){
      if(event.keyCode == 13){
        ...
        var question_data = {};       
        var question_data = $("div.jspsych-cued-recall-response").children('textarea').val();
